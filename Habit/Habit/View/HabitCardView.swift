    ...
    static var previews: some View {
        ForEach(ColorScheme.allCases, id: \.self)  {
            NavigationView {
                ...
                List {
                    HabitCardView(viewModel: HabitCardViewModel(id: 1, icon: "https://via.placeholder.com/150", date: "01/01/2021 00:00:00", name: "Tocar guitarra", label: "horas", value: "2", state: .green))
